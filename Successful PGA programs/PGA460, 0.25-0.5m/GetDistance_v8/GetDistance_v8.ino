...
byte fixedThr = 0;            // set P1 and P2 thresholds to 0=%25, 1=50%, or 2=75% of max; initial minDistLim (i.e. 20cm) ignored
...
byte cdMultiplier = 5;        // multiplier for command cycle delay
...
void setup() {                // put your setup code here, to run once
  initPGA460();
  Serial1.flush();
  //ussc.autoThreshold(0x00,0x10,0x10,0x0C,0x64);
  delay(4000);
  //Serial.println();
  //Serial.println("Threshold values:   ");
  //ussc.thresholdBulkRead(0x00);
